...
class TestBoxService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_config.logger = Mock()  # BoxService uses the logger from config
        self.box_service = BoxService(client=self.mock_api_client, config=self.mock_config)
        self.box_id = "box-test-123"

    def test_init(self):
        """Test BoxService initialization."""
        self.assertIs(self.box_service.client, self.mock_api_client)
        self.assertIs(self.box_service.logger, self.mock_config.logger)
    ...
    def test_list_no_filters(self):
        ...
        response = self.box_service.list()
    ...
    def test_list_with_filters(self):
        ...
        response = self.box_service.list(filters=filters)
    ...
    def test_get(self):
        ...
        response = self.box_service.get(self.box_id)
    ...
    def test_create_minimal(self):
        ...
        response = self.box_service.create(image=image)
    ...
    def test_create_all_args(self):
        ...
        response = self.box_service.create(**args)
    ...
    def test_delete_no_force(self):
        ...
        response = self.box_service.delete(self.box_id, force=False)
    ...
    def test_delete_force(self):
        ...
        response = self.box_service.delete(self.box_id, force=True)
    ...
    def test_delete_all_no_force(self):
        ...
        response = self.box_service.delete_all(force=False)
    ...
    def test_delete_all_force(self):
        ...
        response = self.box_service.delete_all(force=True)
    ...
    def test_start(self):
        ...
        response = self.box_service.start(self.box_id)
    ...
    def test_stop(self):
        ...
        response = self.box_service.stop(self.box_id)
    ...
    def test_run(self):
        ...
        response = self.box_service.run(self.box_id, command=command)
    ...
    def test_reclaim_specific_box_no_force(self):
        ...
        response = self.box_service.reclaim(box_id=self.box_id, force=False)
    ...
    def test_reclaim_all_boxes_force(self):
        ...
        response = self.box_service.reclaim(box_id=None, force=True)
    ...
    def test_get_archive(self):
        ...
        response = self.box_service.get_archive(self.box_id, path=path)
    ...
    def test_extract_archive(self):
        ...
        response = self.box_service.extract_archive(
            self.box_id, path=path, archive_data=archive_data
        )
    ...
    def test_head_archive(self):
        ...
        response = self.box_service.head_archive(self.box_id, path=path)
